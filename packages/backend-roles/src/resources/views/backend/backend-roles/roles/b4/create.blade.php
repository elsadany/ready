...
@section("title"){{trans('backend-roles::roles.create')}} {{trans('backend-roles::roles.roles')}} @stop
...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">{{trans('backend-roles::roles.create')}}</li>
</ol>



<div class="card">
    <div class="card-header bg-primary"><h3 class="card-title text-light">{{trans('backend-roles::roles.create')}} {{trans('backend-roles::roles.roles')}}</h3></div>
    <div class="card-body">
