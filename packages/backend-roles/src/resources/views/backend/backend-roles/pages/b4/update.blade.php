...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">{{trans('backend-roles::pages.update')}}</li>
</ol>

<div class="card">
    <div class="card-header bg-primary"><h3 class="card-title text-light">{{trans('backend-roles::pages.update')}} {{trans('backend-roles::pages.pages')}}</h3></div>
    <div class="card-body">
