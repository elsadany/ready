...
<div class="row" style="background-color: #FFFFFF;    padding: 0 10px 0px 10px;">
    ...
    <ol class="breadcrumb">
      <li><a href="#">{{trans('backend-languages::lang.home')}}</a></li>
      <li><a href="./backend/languages">{{trans('backend-languages::lang.languages')}}</a></li>
      <li class="active">{{trans('backend-languages::lang.create')}}</li>
    </ol>
</div>
...
<div class="panel panel-primary">
    <div class="panel-heading"><h3 class="panel-title">{{trans('backend-languages::lang.create')}} {{trans('backend-languages::lang.languages')}}</h3></div>
