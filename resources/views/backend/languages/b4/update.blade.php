...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="javascript:void()">{{trans('backend-languages::lang.home')}}</a></li>
    <li class="breadcrumb-item"><a href="./backend/languages">{{trans('backend-languages::lang.languages')}}</a></li>
    <li class="breadcrumb-item active">{{trans('backend-languages::lang.update')}}</li>
</ol>

<div class="card">
    <div class="card-header bg-primary"><h3 class="card-title text-light">{{trans('backend-languages::lang.update')}} {{trans('backend-languages::lang.languages')}}</h3></div>
    <div class="card-body">
