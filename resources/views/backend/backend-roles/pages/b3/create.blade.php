...
<div class="row" style="background-color: #FFFFFF;    padding: 0 10px 0px 10px;">
    ...
    <ol class="breadcrumb">
      <li><a href="#">{{trans('backend-roles::pages.home')}}</a></li>
      <li><a href="./backend/pages">{{trans('backend-roles::pages.pages')}}</a></li>
      <li class="active">{{trans('backend-roles::pages.create')}}</li>
    </ol>
</div>
...
<div class="panel panel-primary">
    <div class="panel-heading"><h3 class="panel-title">{{trans('backend-roles::pages.create')}} {{trans('backend-roles::pages.pages')}}</h3></div>
