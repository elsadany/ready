...
<div class="row" style="background-color: #FFFFFF;    padding: 0 10px 0px 10px;">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">{{trans('backend-roles::roles.create')}}</li>
    </ol>
</div>
...
<div class="panel panel-primary">
    <div class="panel-heading"><h3 class="panel-title">Create pages</h3></div>
    ...
    @include(config("backend-roles.templates_path").".backend-roles.roles._form")
