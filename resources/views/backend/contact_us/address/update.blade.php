...
@section("title"){{trans("contactus::contactus.update")}} {{trans("contactus::contactus.address")}} @stop
...
<nav>
    <ol class="breadcrumb">
      ...
      <li class="active breadcrumb-item">{{trans("contactus::contactus.update")}}</li>
    </ol>
</nav>

<div class="card ">
    <div class="card-header bg-primary"><h3 class="panel-title  text-light">{{trans("contactus::contactus.update")}} {{trans("contactus::contactus.address")}}</h3></div>
    <div class="card-body">
